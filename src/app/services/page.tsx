        ...
        <section className="py-32 bg-gray-50 overflow-hidden">
          <Container>
            <div className="text-center mb-24">
              ...
              <motion.p {...fadeIn} transition={{ delay: 0.1 }} className="text-xl text-gray-500 max-w-2xl mx-auto font-medium">We've refined a process that ensures quality, speed, and absolute clarity at every stage of development.</p>
            </div>
