...
import { ArrowRight, Layers } from 'lucide-react'; // Removed Laptop icon
      ...
      <Container>
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-md sm:text-lg text-muted-foreground max-w-2xl md:max-w-3xl mx-auto">
            Discover expert digital solutions tailored to your needs.
          </p>
        </div>

        <div className="flex justify-center"> {/* Changed grid to flex justify-center for single card */}
          {/* Services Category Card - Now the only card */}
