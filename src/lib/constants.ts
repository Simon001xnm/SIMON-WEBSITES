...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    image: 'https://source.unsplash.com/600x400/?community,platform',
  ...
  },
  {
    ...
    image: 'https://source.unsplash.com/600x400/?tech,solutions',
  ...
  },
  {
    ...
    image: 'https://source.unsplash.com/600x400/?booking,interface',
    dataAiHint: 'booking interface',
    techStack: ['Ruby on Rails', 'React', 'PostgreSQL', 'Sidekiq', 'Stripe API'],
    liveUrl: '#', // This was https://bms-28in.vercel.app/, but AppointEase seems more generic
    repoUrl: 'https://github.com/Symoh242', // This was previously '#', updated to main GH as placeholder
    projectType: 'Web',
  },
  {
    id: '6',
    ...
    image: 'https://source.unsplash.com/600x400/?software,company',
